...
/*   Updated: 2026/03/15 15:14:12 by jle-doua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Server::_addNewClient(int serverFd) {
	...
	_clientMetadata[clientFd] = std::make_pair(remoteAddr, serverPort);
...
void	Server::_parseResponse(Client *c, int errCode) {
	...
	if (_clientMetadata.find(clientFd) != _clientMetadata.end()) {
